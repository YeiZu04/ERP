...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CurriculumCandidate>(entity =>
        {
            entity.HasKey(e => e.IdCurriculumCandidate).HasName("PK__Curricul__1F7DA07626B967EF");

            entity.ToTable("CurriculumCandidate");

            entity.Property(e => e.IdCurriculumCandidate).HasColumnName("id_curriculumCandidate");
            entity.Property(e => e.IdCandidateFk).HasColumnName("id_candidate_fk");
            entity.Property(e => e.PathCurriculumCandidate)
                .HasMaxLength(1000)
                .IsFixedLength()
                .HasColumnName("path_curriculum_candidate");

            entity.HasOne(d => d.IdCandidateFkNavigation).WithMany(p => p.CurriculumCandidates)
